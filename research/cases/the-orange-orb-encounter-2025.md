...
During a mission to investigate loud noises (thuds) and recent UAP sightings in a mountain range, a helicopter crew encountered several unidentified objects. The encounter occurred during the evening transition from daylight to night, utilizing both the naked eye and Night Vision Goggles (NVG) / Forward Looking Infrared (FLIR).

### Flight Characteristics and Behavior
The observed UAPs exhibited several highly anomalous behaviors:
- **Multi-Object Transition:** At least one object was observed splitting into two, with a smaller object emerging before the main body accelerated out of sight.
...
- **Infrared Signature:** Ground teams reported the object as being "super-hot" on FLIR (Forward Looking Infrared) sensors, indicating a significant thermal signature.

## Key Entities/Facts
- **Witnesses:** A senior U.S. Intelligence Official (USIC), a colleague, and two helicopter pilots.
- **Timeframe:** Late 2025.
- **Primary Visuals:** Orange, oval-shaped orbs with white/yellow centers.
- **Key Behaviors:** Splitting/fragmenting, swarm behavior, formation flying (T-shape, triangle), and extreme maneuverability/speed.
...
- [Extracted Markdown via Local SearXNG/Fetch Content]
