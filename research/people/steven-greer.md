...
- **Foundations and Organizations**:
    - **[[organizations/disclosure-project]]**: Founded by Greer to seek the disclosure of alleged classified UFO information.
    - **Center for the Study of Extraterrestrial Intelligence (CSETI)**: Established in 1990s to create a diplomatic and research-based initiative to contact extraterrestrial civilizations.
    - **The Orion Project** and **Sirius Technology Advanced Research, LLC**: Other entities associated with his work.
- **[[protocols/ce5-protocol]]**: Developed the "Close Encounters of the Fifth Kind" (CE-5) protocol, which focuses on human-initiated contact with extraterrestrial civilizations.
- **Key Events**:
...
- **Organizations**:
    ...
    - [Center for the Study of Exraterrestrial Intelligence (CSETI)](https://www.wikidisc.org/wiki/Center_for_the_Study_of_Extraterrestrial_Intelligence_(CSETI))
    - [The Orion Project]
- **Protocols**:
...
- [Disclosdex - Steven Greer](https://disclosdex.com/people/steven-greer)
- [Dr. Steven Greer Official Website](https://drstevengreer.com/)
- [WikiDisc - Steven Greer](httpshttps://www.wikidisc.org/wiki/Steven_Greer)
